...
namespace _GurkanTemplate.Scripts.ColorUtil
{
	...
	public static class ColorUtilities
	{
		 ...
		 */
		public static LabColor XYZToCIE_Lab(XYZColor xyz)
		{
		 ...
		 */
		public static float DeltaE(LabColor lhs, LabColor rhs)
		{
			return Mathf.Sqrt(
		...
		public static HSVColor RGBtoHSV(Color color)
		{
			...
			if( Mathf.Abs(r-max) < Mathf.Epsilon )
			{
				h = ( g - b ) / delta;		// between yellow & magenta
				if(float.IsNaN(h))
					h = 0f;
			}
			else if( Mathf.Abs(g-max) < Mathf.Epsilon )
			{
		...
		{
			LabColor lab = LabColor.FromRGB(InColor);

			string name = "Unknown";
			float diff = Mathf.Infinity;
			foreach(KeyValuePair<string, LabColor> kvp in ColorNameLookup)
			{
		...
		/*public static Color LerpLab(Color lhs, Color rhs, float value)
		{
			var lhsLab = CIELabFromRGB(lhs.r, lhs.g, lhs.b, 100f);
			var rhsLab = CIELabFromRGB(rhs.r, rhs.g, rhs.b, 100f);
			var outputLab = new LabColor(Mathf.Lerp(lhsLab.L, rhsLab.L, value),
				Mathf.Lerp(lhsLab.a, rhsLab.a, value),
				Mathf.Lerp(lhsLab.a, rhsLab.a, value));
			
		}*/

		static LabColor CIELabFromRGB(float R, float G, float B, float Scale)
		{
		 ...
		 */
		static readonly Dictionary<string, LabColor> ColorNameLookup = new Dictionary<string, LabColor>()
		{
			...
			{ "Air Force Blue",						CIELabFromRGB(36f, 54f, 66f, 100f)		},							
			...
			{ "Ao",								CIELabFromRGB(0f, 50f, 0f, 100f)		},							
			...
			{ "Brown",						CIELabFromRGB(59f, 29f, 0f, 100f)		},							
			...
			{ "Chartreuse",					CIELabFromRGB(87f, 100f, 0f, 100f)		},							
			...
			{ "Chocolate",							CIELabFromRGB(82f, 41f, 12f, 100f)		},							
			...
			{ "Dark Gray",							CIELabFromRGB(66f, 66f, 66f, 100f)		},							
			...
			{ "Deep Turquoise",					CIELabFromRGB(5f, 49f, 38f, 100f)		},							
			...
			{ "Forest Green",							CIELabFromRGB(13f, 55f, 13f, 100f)		},							
			...
			{ "Gamboge Orange",						CIELabFromRGB(60f, 40f, 0f, 100f) },
			...
			{ "Gold",							CIELabFromRGB(83f, 69f, 22f, 100f) },
			...
			{ "Green",			CIELabFromRGB(0f, 100f, 0f, 100f) },
			...
			{ "Indig",								CIELabFromRGB(29f, 0f, 51f, 100f) },
			{ "International Klein Blue",					CIELabFromRGB(0f, 18f, 65f, 100f) },
			{ "International Orange",			CIELabFromRGB(100f, 31f, 0f, 100f) },
			...
			{ "Jawad/Chicken Color",		CIELabFromRGB(76f, 69f, 57f, 100f) },
			{ "Khaki",					CIELabFromRGB(94f, 90f, 55f, 100f) },
			...
			{ "Lavender",								CIELabFromRGB(90f, 90f, 98f, 100f) },
			...
			{ "Lime",							CIELabFromRGB(75f, 100f, 0f, 100f) },
			...
			{ "Maroon",							CIELabFromRGB(76f, 13f, 28f, 100f) },
			...
			{ "Midnight Green",				CIELabFromRGB(0f, 29f, 33f, 100f) },
			...
			{ "Orange",						CIELabFromRGB(100f, 50f, 0f, 100f) },
			...
			{ "Smalt",					CIELabFromRGB(0f, 20f, 60f, 100f) },
